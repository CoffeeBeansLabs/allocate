# Generated by Django 4.1.3 on 2023-10-05 04:38
...
def get_group_permission_map(content_type):
    group_permission_map = {
        RoleKeys.SUPER_ADMIN: {
            ...
            'codenames': ['login', 'search_talent', 'add_role', 'view_user', 'change_user']
        },
        RoleKeys.VIEWER: {
            'content_type': content_type,
            'codenames': ['login', 'search_talent', 'view_user']
        },
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authapp', '0027_add_new_user_groups'),
    ]
