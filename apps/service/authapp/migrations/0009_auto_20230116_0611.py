# Generated by Django 4.1.3 on 2023-01-16 06:11
...
def get_group_permission_map(content_type):
    group_permission_map = {
        RoleKeys.ACCOUNT_MANAGER: {
            ...
            'codenames': ['add_projectallocationrequest', 'view_projectallocationrequest']
        },
        RoleKeys.ADMIN: {
            'content_type': content_type,
            'codenames': ['view_projectallocationrequest']
        }
    }
...
class Migration(migrations.Migration):
    dependencies = [
        ("authapp", "0008_auto_20230105_0828"),
